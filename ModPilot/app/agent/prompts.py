...
_WIDGET_PROTOCOL: str = (
    ...
    "  IMPORTANT: a slot whose value is the empty string `\"\"` means the user\n"
    "  EXPLICITLY cleared it in the widget — treat it as a refusal of any\n"
    "  texture in that slot. Do NOT re-classify it, do NOT call\n"
    "  `material_inspect` again to refresh suggestions, do NOT substitute a\n"
    "  filename you find elsewhere. Pass the empty value through to\n"
    "  `material_setup` unchanged; the wiring code already skips empties.\n"
    "\n"
